...
import { getChildren as getChildren$1 } from 'idyll-ast';
...
var ReactJsonSchema = /*#__PURE__*/function () {
  ...
  _createClass(ReactJsonSchema, [{
    ...
    value: function createComponent(schema) {
      ...
      schema.component;
          schema.children;
          var rest = _objectWithoutProperties(schema, _excluded$4);

      var Component = this.resolveComponent(schema);
      var Children = this.resolveComponentChildren(schema);
      return /*#__PURE__*/createElement(Component, rest, Children);
    }
  }, {
    ...
    value: function resolveComponent(schema) {
      ...
      var _schema$component$spl = schema.component.split('.'),
          _schema$component$spl2 = _toArray(_schema$component$spl),
      ...
      if (!Component) {
        if (DOM.hasOwnProperty(name)) {
          ...
          return function () {
            ...
            }, /*#__PURE__*/React.createElement("pre", null, "Could not find an implementation for: ", schema.component));
          };
        }
  ...
  _createClass(AuthorTool, [{
      ...
      return metaValues.props.map(function (prop) {
        ...
        if (runtimeValue !== undefined) {
          if (runtimeValue && {}.toString.call(runtimeValue) === '[object Function]') {
            currentPropValue = /*#__PURE__*/React.createElement("em", null, "function");
          } else {
        ...
        }, /*#__PURE__*/React.createElement("td", null, prop.name), /*#__PURE__*/React.createElement("td", {
          className: "props-table-type"
        }, prop.type), /*#__PURE__*/React.createElement("td", null, prop.example), /*#__PURE__*/React.createElement("td", null, currentPropValue));
      });
    ...
    value: function handleFormatComponent(runtimeValues) {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "props-table-row"
      }, /*#__PURE__*/React.createElement("th", null, "Prop"), /*#__PURE__*/React.createElement("th", null, "Type"), /*#__PURE__*/React.createElement("th", null, "Example"), /*#__PURE__*/React.createElement("th", null, "Current Value")), showProps)), /*#__PURE__*/React.createElement("div", {
    ...
    value: function render() {
      ...
      }, props.component, /*#__PURE__*/React.createElement("button", {
      ...
      }, props.authorComponent.type._idyll.name, " Component"), /*#__PURE__*/React.createElement("div", {
...
var buildExpression = function buildExpression(acc, expr, isEventHandler) {
  ...
  try {
    modifiedExpression = falafel(isEventHandler ? expr : "var __idyllReturnValue = ".concat(expr || 'undefined'), function (node) {
      switch (node.type) {
        case 'Identifier':
  ...
  if (isEventHandler) {
    return function () {
      ...
      __idyllCopy: function copy(o) {
        ...
        for (key in o) {
          v = o[key];
          output[key] = _typeof(v) === 'object' ? copy(v) : v;
        }
...
var filterIdyllProps = function filterIdyllProps(props, filterInjected) {
  ...
  if (filterInjected) {
    rest.idyll;
        rest.hasError;
        rest.updateProps;
        var ret = _objectWithoutProperties(rest, _excluded2$1);
...
var findWrapTargets = function findWrapTargets(schema, state, components) {
  ...
  mapTree(schema, function (node) {
    ...
    node.component;
        ...
        props = _objectWithoutProperties(node, _excluded3$1);
...
var getRefs = function getRefs() {
  ...
  scrollWatchers.forEach(function (watcher) {
    ...
    var watchItem = watcher.watchItem;
        ...
        watcher.offsets;
        var watcherProps = _objectWithoutProperties(watcher, _excluded);
...
var createWrapper = function createWrapper(_ref) {
  ...
  return /*#__PURE__*/function (_React$PureComponent) {
    ...
    function Wrapper(props) {
      ...
      _this.ref = {};
      _this.onUpdateRefs = _this.onUpdateRefs.bind(_assertThisInitialized(_this));
      _this.onUpdateProps = _this.onUpdateProps.bind(_assertThisInitialized(_this));
    ...
    _createClass(Wrapper, [{
      ...
      value: function render() {
        ...
        var _filterIdyllProps = filterIdyllProps(this.props, this.props.isHTMLNode),
            ...
            passThruProps = _objectWithoutProperties(_filterIdyllProps, _excluded2);

        var childComponent = null;
        var uniqueKey = "".concat(this.key, "-help");
        var returnComponent = React.Children.map(children, function (c, i) {
          childComponent = c;
          return /*#__PURE__*/React.cloneElement(c, _objectSpread(_objectSpread({
        ...
        if (this.state.hasError) {
          returnComponent = /*#__PURE__*/React.createElement("div", {
            style: {
        ...
        if (authorView) {
          ...
          if (metaData && metaData.name === 'TextContainer' || ['TextContainer', 'DragDropContainer'].includes(childComponent.type.name)) {
            ...
            return /*#__PURE__*/React.createElement(_ViewComponent, {
              idyllASTNode: this.props.idyllASTNode,
            ...
            return /*#__PURE__*/React.createElement(InlineViewComponent, {
              idyllASTNode: this.props.idyllASTNode,
              component: returnComponent,
              authorComponent: childComponent,
              uniqueKey: uniqueKey
...
var IdyllRuntime = /*#__PURE__*/function (_React$PureComponent2) {
  ...
  function IdyllRuntime(props) {
    ...
    _this3.state = {};
    _this3.scrollListener = _this3.scrollListener.bind(_assertThisInitialized(_this3));
    _this3.initScrollListener = _this3.initScrollListener.bind(_assertThisInitialized(_this3));
    var ast = filterASTForDocument(props.ast);

    var _splitAST = splitAST(getChildren$1(ast)),
        vars = _splitAST.vars,
    ...
    asyncDataStoreKeys.map(function (key) {
      asyncDataStore[key].dataPromise.then(function (res) {
        _this3.updateState(_objectSpread(_objectSpread({}, _this3.state), {}, _defineProperty({}, key, res)));
      })["catch"](function (e) {
    ...
    var transformedSchema = mapTree(schema, function (node, depth) {
      ...
      if (!wrapTargets.includes(node)) {
        if (_this3.props.wrapTextComponents.indexOf(node.component) > -1 && _this3.props.textEditComponent) {
          var _idyllASTNode2 = node.idyllASTNode,
              _rest = _objectWithoutProperties(node, _excluded3);
        ...
        node.idyllASTNode;
            var rest = _objectWithoutProperties(node, _excluded4);
      ...
      node.component;
          ...
          var __vars__ = node.__vars__,
          __expr__ = node.__expr__,
          props = _objectWithoutProperties(node, _excluded5);
  ...
  _createClass(IdyllDocument, [{
    ...
    value: function componentDidMount() {
      ...
      if (!this.props.ast && this.props.markup) {
        compile(this.props.markup, this.props.compilerOptions).then(function (ast) {
          _this2.setState({
            ast: ast,
    ...
    value: function UNSAFE_componentWillReceiveProps(newProps) {
      ...
      if (hash !== this.state.hash) {
        ...
        compile(newProps.markup, newProps.compilerOptions).then(function (ast) {
          _this3.setState({
            previousAST: ast,
            ast: ast,
            hash: hash,
    ...
    value: function getErrorComponent() {
      ...
      return /*#__PURE__*/React.createElement(this.props.errorComponent || 'pre', {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(IdyllRuntime, _extends({}, this.props, {
        key: this.state.hash,
...
export { IdyllDocument as default };
