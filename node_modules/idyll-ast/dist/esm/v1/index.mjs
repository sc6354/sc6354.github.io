...
export { appendNode, appendNodes, createNode, createTextNode, filterChildren, filterNodes, findNodes, getChildren, getNodeName, getNodesByName, getProperties, getPropertiesByType, getProperty, getText, modifyChildren, modifyNodesByName, prependNode, prependNodes, removeNodesByName, removeProperty, setProperties, setProperty, walkNodes, walkNodesBreadthFirst };
