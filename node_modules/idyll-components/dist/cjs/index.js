...
var SyntaxHighlighter = require('react-syntax-highlighter/dist/light');
var style = require('react-syntax-highlighter/dist/styles/github');
...
var InlineSVG__default = /*#__PURE__*/_interopDefaultLegacy(InlineSVG);
var PropTypes__default = /*#__PURE__*/_interopDefaultLegacy(PropTypes$1);

class Action extends React__default["default"].PureComponent {
  render() {
    const {
      idyll,
      hasError,
...
class Analytics extends React__default["default"].PureComponent {
  componentDidMount() {
    try {
...
class Aside extends React__default["default"].PureComponent {
  render() {
...
class Boolean extends React__default["default"].PureComponent {
  constructor(props) {
    super(props);
  }
...
class Button extends React__default["default"].PureComponent {
  render() {
    const {
      onClick,
      idyll,
...
class Chart extends React__default["default"].PureComponent {
  constructor(props) {
    super(props);
    this.id = chartCount++;
  }
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    }, type !== 'PIE' ? /*#__PURE__*/React__default["default"].createElement(V.VictoryChart, _extends__default["default"]({
      ...
      clipId: `clip-${id}`,
      theme: theme
    }), /*#__PURE__*/React__default["default"].createElement(INNER_CHART, _extends__default["default"]({
      data: data,
      x: props.x,
      y: props.y
    }, customProps))) : /*#__PURE__*/React__default["default"].createElement(INNER_CHART, {
      data: data,
...
class CodeHighlight extends React__default["default"].PureComponent {
  render() {
    return /*#__PURE__*/React__default["default"].createElement(SyntaxHighlighter__default["default"], {
      style: style__default["default"],
...
class Dynamic extends React__default["default"].PureComponent {
  componentDidMount() {
    let node;
...
class Desmos extends React__default["default"].Component {
  constructor(props) {
    super(props);
    this.state = {
...
class Equation extends React__default["default"].PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      showRange: false
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement("span", {
      style: style
    }, /*#__PURE__*/React__default["default"].createElement(Latex, {
...
class Fixed extends React__default["default"].PureComponent {
  render() {
    return /*#__PURE__*/React__default["default"].createElement("div", {
      style: {
        position: 'fixed',
...
class Float extends React__default["default"].PureComponent {
  render() {
    return /*#__PURE__*/React__default["default"].createElement("div", {
...
class EmbeddedGist extends React__default["default"].PureComponent {
  constructor(props) {
    super(props);
...
class Graphic extends React$6.Component {
  render() {
    ...
    return /*#__PURE__*/React$6.createElement("div", _extends__default["default"]({
...
const ByLineMultipleAuthors = ({
  ...
  return /*#__PURE__*/React__default["default"].createElement("span", {
    key: authorDisplay
  }, typeof author.link === 'string' ? /*#__PURE__*/React__default["default"].createElement(AuthorLink, _extends__default["default"]({}, author, {
    color: color
  })) : authorDisplay, additionalTextByIndex(authors, suffix, joint, i));
}));

class Header extends React__default["default"].PureComponent {
  render() {
    const {
      background,
      color,
    ...
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      className: 'hed'
    }, this.props.title), this.props.subtitle && /*#__PURE__*/React__default["default"].createElement("h2", {
      className: 'dek'
    }, this.props.subtitle), this.props.author && /*#__PURE__*/React__default["default"].createElement("div", {
      className: 'byline'
    }, `${prefix.trim()} `, /*#__PURE__*/React__default["default"].createElement("a", {
      target: "_blank",
      href: this.props.authorLink,
      style: {
        color: _color
      }
    }, this.props.author)), !!this.props.authors && /*#__PURE__*/React__default["default"].createElement(ByLineMultipleAuthors, {
      authors: this.props.authors,
      prefix: prefix.trim(),
      joint: joint.trim(),
      suffix: suffix.trim(),
      color: _color
    }), this.props.date && /*#__PURE__*/React__default["default"].createElement("div", {
...
const GenerateHeaders = props => {
  ...
  return /*#__PURE__*/React__default["default"].createElement(HeaderTag, attributeProps, children);
};

class H1 extends React__default["default"].PureComponent {
  render() {
    return /*#__PURE__*/React__default["default"].createElement(GenerateHeaders, _extends__default["default"]({
      size: "1"
    }, this.props));
  }
...
class H2 extends React__default["default"].PureComponent {
  render() {
    return /*#__PURE__*/React__default["default"].createElement(GenerateHeaders, _extends__default["default"]({
      size: "2"
    }, this.props));
...
class H3 extends React__default["default"].PureComponent {
  render() {
    return /*#__PURE__*/React__default["default"].createElement(GenerateHeaders, _extends__default["default"]({
      size: "3"
    }, this.props));
...
class H4 extends React__default["default"].PureComponent {
  render() {
    return /*#__PURE__*/React__default["default"].createElement(GenerateHeaders, _extends__default["default"]({
      size: "4"
    }, this.props));
...
class H5 extends React__default["default"].PureComponent {
  render() {
    return /*#__PURE__*/React__default["default"].createElement(GenerateHeaders, _extends__default["default"]({
      size: "5"
    }, this.props));
...
class H6 extends React__default["default"].PureComponent {
  render() {
    return /*#__PURE__*/React__default["default"].createElement(GenerateHeaders, _extends__default["default"]({
      size: "6"
    }, this.props));
...
class Inline extends React__default["default"].PureComponent {
  render() {
    return /*#__PURE__*/React__default["default"].createElement("div", {
      style: {
...
class Link extends React__default["default"].PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement("a", passProps, props.text || props.children);
  }
...
class Preloader extends React__default["default"].PureComponent {
  componentDidMount() {
    const {
      images
    } = this.props;
...
class Preview extends React__default["default"].Component {
  constructor(props) {
    super(props);
    this.state = {
      mounted: false
  ...
  render() {
    ...
    if (this.props.media) {
      return /*#__PURE__*/React__default["default"].createElement(ReactTinyLink, {
        header: title,
...
class Range extends React__default["default"].PureComponent {
  constructor(props) {
    super(props);
  }
...
class TextContainer extends React__default["default"].PureComponent {
  render() {
    const {
      idyll,
      children,
...
class Stepper extends React__default["default"].PureComponent {
  constructor(props) {
    super(props);
    this.SCROLL_STEP_MAP = {};
    this.SCROLL_NAME_MAP = {};
...
class SVG extends React__default["default"].PureComponent {
  render() {
    const {
      hasError,
      updateProps,
    ...
    if (!this.props.src) {
      return /*#__PURE__*/React__default["default"].createElement("svg", props);
    }

    return /*#__PURE__*/React__default["default"].createElement(InlineSVG__default["default"], props);
  }
...
class TextInput extends React__default["default"].PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/React__default["default"].createElement(React$b.Fragment, null, /*#__PURE__*/React__default["default"].createElement("input", _extends__default["default"]({
...
class Tweet extends React$b.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
    ...
    this.tweetContainer = /*#__PURE__*/React$b.createRef();
...
class YoutubeComponent extends React__default["default"].Component {
  constructor(props) {
    super(props);
    this.state = {
      mounted: false
  ...
  render() {
    ...
    }, /*#__PURE__*/React__default["default"].createElement(YouTube, {
      key: this.props.id,
...
exports.Case = Case;
exports.Chart = Chart;
exports.Checkbox = Boolean;
exports.Cite = Cite;
exports.CodeHighlight = CodeHighlight;
exports.Conditional = Conditional;
exports.Default = Default;
exports.Desmos = Desmos;
exports.Display = Display;
exports.Dynamic = Dynamic;
exports.Equation = Equation;
exports.Fixed = Fixed;
exports.Float = Float;
exports.Gist = EmbeddedGist;
...
exports.Tweet = Tweet;
exports.Youtube = YoutubeComponent;
