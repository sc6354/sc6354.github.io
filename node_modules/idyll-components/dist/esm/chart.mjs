...
class Chart extends React.PureComponent {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }, type !== 'PIE' ? /*#__PURE__*/React.createElement(V.VictoryChart, _extends({
      ...
      clipId: `clip-${id}`,
      theme: theme
    }), /*#__PURE__*/React.createElement(INNER_CHART, _extends({
      data: data,
      x: props.x,
      y: props.y
    }, customProps))) : /*#__PURE__*/React.createElement(INNER_CHART, {
      data: data,
