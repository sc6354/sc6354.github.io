...
const ByLineMultipleAuthors = ({
  ...
  return /*#__PURE__*/React.createElement("span", {
    key: authorDisplay
  }, typeof author.link === 'string' ? /*#__PURE__*/React.createElement(AuthorLink, _extends({}, author, {
    color: color
...
class Header extends React.PureComponent {
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: 'dek'
    }, this.props.subtitle), this.props.author && /*#__PURE__*/React.createElement("div", {
      className: 'byline'
    }, `${prefix.trim()} `, /*#__PURE__*/React.createElement("a", {
      target: "_blank",
      href: this.props.authorLink,
      style: {
        color: _color
      }
    }, this.props.author)), !!this.props.authors && /*#__PURE__*/React.createElement(ByLineMultipleAuthors, {
