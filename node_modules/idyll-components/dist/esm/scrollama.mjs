...
(function (global, factory) {
  ...
  function scrollama() {
    ...
    function notifyStepEnter(element, dir, check = true) {
      ...
      step.direction = dir;
      step.state = 'enter'; // if (isPreserveOrder && check && dir === 'down') notifyOthers(index, 'above');
...
var scrollama = scrollama$1.exports;

export { scrollama as default };
